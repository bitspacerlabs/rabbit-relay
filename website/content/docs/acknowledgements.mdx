...
description: How ACK, NACK, requeue, and dead-letter work in Rabbit Relay consumers
icon: CheckSquare
---
...
<Cards>
  <Card title="Delivery Semantics" description="Understand at-least-once delivery guarantees." href="/docs/delivery-semantics" />
  <Card title="Retry, DLQ, and Redrive" description="Build production failure paths." href="/docs/retry-dlq-redrive" />
</Cards>
