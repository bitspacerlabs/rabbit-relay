...
<Cards>
  <Card title="Quickstart" description="Publish and consume your first typed event." href="/docs/quickstart" />
  <Card title="Delivery Semantics" description="ACKs, crashes, and duplicate handling." href="/docs/delivery-semantics" />
</Cards>
