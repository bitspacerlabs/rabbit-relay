...
description: Core RabbitMQ concepts, brokers, producers, consumers, and how Rabbit Relay maps them
icon: Server
---
...
![Direct HTTP communication](/http-call.png)

You can have this:

![RabbitMQ-based communication](/rabbitmq-connection.png)
...
<Cards>
  ...
  <Card title="Exchanges, Queues, and Bindings" description="Learn how RabbitMQ routes messages." href="/docs/exchanges-queues-bindings" />
</Cards>
