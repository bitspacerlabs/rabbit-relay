...
description: Know for sure whether RabbitMQ accepted your message before proceeding
icon: CheckCheck
---
...
<Cards>
  <Card title="Configuration" description="Broker defaults and exchange options" href="/docs/configuration" />
  <Card title="Error Handling" description="Recover from publish and consume failures" href="/docs/error-handling" />
</Cards>
