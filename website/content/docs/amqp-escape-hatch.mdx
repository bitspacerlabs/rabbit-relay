...
description: Drop down to native AMQP options for advanced behavior while keeping Rabbit Relay's safe defaults.
icon: DoorOpen
---
...
<Cards>
  ...
  <Card title="Typed Events" description="Type-safe event factories and publish/subscribe patterns" href="/docs/typed-events" />
</Cards>
