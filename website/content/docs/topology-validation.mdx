...
description: Passive checks that verify planned RabbitMQ topology exists without declaring or modifying resources.
icon: FileCheck
---
...
<Cards>
  <Card title="Topology Modes" description="Control topology ownership per environment" href="/docs/topology-modes" />
