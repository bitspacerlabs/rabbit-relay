...
<Cards>
  <Card title="OpenTelemetry" description="Integrate distributed tracing with OTel" href="/docs/opentelemetry" />
  <Card title="Typed Events" description="Strongly typed event envelopes and factories" href="/docs/typed-events" />
</Cards>
