---
title: TTL De‑duplication
description: Consumer-side safeguard that suppresses duplicate messages within a short time window while keeping at-least-once delivery semantics.
icon: CopyX
---
...
<Cards>
  <Card title="Delivery Semantics" description="At-least-once delivery and idempotency requirements" href="/docs/delivery-semantics" />
  <Card title="Configuration" description="Broker defaults, exchange options, and topology ownership" href="/docs/configuration" />
</Cards>
