...
<Cards>
  <Card title="Configuration" description="Broker options and environment setup." href="/docs/configuration" />
  <Card title="Topology CLI" description="Plan, validate, and diff topology from the command line." href="/docs/cli-reference" />
</Cards>
