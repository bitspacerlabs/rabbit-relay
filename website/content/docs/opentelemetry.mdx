...
description: Optional OpenTelemetry lifecycle adapter that creates spans for operational events without runtime dependencies.
icon: Activity
---
...
<Cards>
  <Card title="Headers & Tracing" description="Propagate trace context through message headers" href="/docs/headers-and-tracing" />
