...
- [Quickstart](/docs/quickstart) — publish your first type-safe event in minutes
- [Configuration](/docs/configuration) — broker defaults, exchange options, and topology ownership
