...
description: Protect publishers from accidentally sending oversized messages to RabbitMQ.
icon: Scaling
---
...
<Cards>
  ...
  <Card title="Publisher Confirms" description="Ensure RabbitMQ accepted your messages" href="/docs/publisher-confirms" />
</Cards>
