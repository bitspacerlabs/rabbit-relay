...
<Cards>
  <Card title="Quickstart" description="Your first producer and consumer." href="/docs/quickstart" />
  <Card title="Retry & DLQ" description="The reliability pipeline most examples build on." href="/docs/retry-dlq" />
</Cards>
