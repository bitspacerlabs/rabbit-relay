---
title: Plugins
description: Add cross-cutting behavior to publishing and consuming without touching business logic
icon: Puzzle
---
...
<Callout title="Note">
  Plugin errors are **logged** and do **not** stop publishing or consuming.
  Handlers are still invoked. Plugins should be fast and non‑blocking.
</Callout>
...
<Cards>
  <Card title="Middleware" description="Local behavior around consumer handlers" href="/docs/middleware" />
