---
title: Health Checks
description: Runtime health information through broker.health() for readiness endpoints, dashboards, and debugging.
icon: HeartPulse
---
...
- [OpenTelemetry Adapter](/docs/opentelemetry)
- [Topology Planner](/docs/topology-planner)
- [Topology Validation](/docs/topology-validation)
- [Retry & DLQ](/docs/retry-dlq)
...
<Cards>
  <Card title="Graceful Shutdown" description="Clean shutdown for tests, Docker, and production deploys" href="/docs/graceful-shutdown" />
