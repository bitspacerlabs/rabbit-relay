...
description: Decide which Rabbit Relay feature to use for your use case.
icon: GitBranch
---
...
<Cards>
  ...
  <Card title="Topology Modes" description="assert, passive, and plan-only topology ownership" href="/docs/topology-modes" />
</Cards>
