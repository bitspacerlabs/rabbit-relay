...
<Cards>
  <Card title="Retry & DLQ" description="Configure dead-letter queues and retry behavior." href="/docs/retry-dlq" />
  <Card title="Topology CLI" description="Plan and validate topology from the command line." href="/docs/cli-reference" />
</Cards>
