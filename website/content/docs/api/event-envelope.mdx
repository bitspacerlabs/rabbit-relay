---
title: EventEnvelope
description: Canonical message format used by Rabbit Relay for all published and consumed messages.
icon: Mail
---
...
<Cards>
  ...
  <Card title="Headers and Tracing" description="Distributed tracing with correlation IDs and message headers" href="/docs/headers-and-tracing" />
</Cards>
