...
<Cards>
  <Card title="Typed Events" description="Create typed event factories for type-safe publishing and consuming" href="/docs/typed-events" />
  <Card title="Configuration" description="Connection URLs, broker options, and environment variables" href="/docs/configuration" />
</Cards>
