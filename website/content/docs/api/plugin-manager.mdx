---
title: PluginManager
description: Register cross-cutting hooks that run during publishing and consuming, plugins are process-wide and optional.
icon: Puzzle
---
...
<Cards>
  <Card title="Plugins" description="Cross-cutting behavior for message processing with lifecycle hooks" href="/docs/plugins" />
  <Card title="Middleware" description="Per-interface middleware for handler execution" href="/docs/middleware" />
</Cards>
